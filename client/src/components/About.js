        ...
        <div className="crypto-container">
          ...
          <div className="text-light">
            ...
            <p>
              ...
              This website acts as a collaborative painting application that
              allows anyone to participate in drawing a picture together online
              and in real time. Every day at midnight (Greenwich Mean Time) the
              canvas is reset and the Crypto-Painting created is gifted as an
              NFT to a random contributor to the painting (anyone who painted at
              least 1 stroke is considered a contributor).
            </p>
            <h3 className="text-center">HOW CAN I PARTICIPATE?</h3>
            <h4>Step 1: Add MetaMask to your browser</h4>
            <p>
              MetaMask is a browser extension that gives you access to an
              Ethereum wallet through your browser, allowing you to interact
              with decentralized applications like Crypto-Painter. Download
              MetaMask at{" "}
            ...
            <p>
              After connecting your wallet to Crypto-Painter, you can now paint
              on the canvas and communicate with other Crypto-Painters via chat.
              You can choose the brush color and width using the menu above the
              canvas. Remember that zooming in and out of the window (ctrl +
              mouse wheel) can make adding details to your drawing much easier.
            </p>
            <h4>Step 4: Win</h4>
            <p>
              After you paint on the canvas, you are considered a contributor to
              the Crypto-Painting. At midnight (Greenwich Mean Time), the
              Crypto-Painting created is gifted to a random contributor as an
              NFT. Now that you're a contributor yourself, you now have a fair
              chance of winning the Crypto-Painting as an NFT. Much luck!
            </p>
            <h3 className="text-center">HOW DO I KNOW IF I WON?</h3>
            <p>
              If you have won the latest Crypto-Painting, you will receive an
              alert from this website with the token ID and the transaction hash
              when you log in (this alert is very noticeable, you will not miss
            ...
            <p>
              In MetaMask's Assets column, click "Import Token" and MetaMask
            ...
            <p>
              Unfortunately, as of now there is no way to actually display your
              NFT in MetaMask's browser extension. To do this, you need to
              install the MetaMask mobile app from the Play Store or App Store.
              After importing your MetaMask wallet with your mnemonic phrase and
              adding BSC as a network in the mobile app, you need to click
              "Import NFTs" in MetaMask's NFTs column. MetaMask will ask you for
            ...
            <p>
              ...
              , Twitter:{" "}
              <a
                href="https://twitter.com/konradgoldammer"
                className="text-light"
              >
                @konradgoldammer
              </a>
            ...
            <p className="m-0">
              If you like this project I would be very greatful if you could
              share it with your friends. Additionaly, you can support me with a
              donation to my ETH/BNB wallet
              0xd4770038BBd26C12c191789CfCF7CBd29932D606 or BTC wallet
              1NnxcZvf9BvDdoNyEtxgTZxcHa54e14HSL ❤. Thanks, Konrad.
            </p>
          </div>
        </div>
      </div>
